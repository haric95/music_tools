...
# This script scans through your local splice library and copies all of the new
# files over to a specified directory. It keeps a record of the original files
# you have in map.json so that sucessive runs only copy new files.
